...
##        arr.append(numpy.ones((1080,1920),dtype='uint8'))
        ...
        for i in range((num-1)//24+1):
            ...
            string = '53 70 6c 64 80 07 38 04 e4 10 00 00 ff ff ff ff ff ff ff ff 00 00 00 00 01 02 01 00 00 01 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 80 0f 00 00 01 00 01 80'
            l = string.split(' ')
            block_start = []
            for each in l:
            ...
            string = '0f 00 01 80 0f 00 01 80 0f 00 01 80 0f 00 01 80 0f 00 01 80 0f 00 01 80 0f 00 01 80 0f 00 01 80 0f 00 01 80 0f 00 01 80 0f 00 01 80 0f 00 01 80 0f 00 01 80 0f 00 01 80'
            l = string.split(' ')
            block_middle_start = []
            for each in l:
            ...
            imagedata = block_start
            
            for ii in range(7):
                imagedata = imagedata + block_64
            # 4032
            for ji in range(7):
                imagedata = imagedata + block_middle_start
                for ii in range(7):
                    imagedata = imagedata + block_64
            # 4372
            imagedata = imagedata + block_end_start
            for ii in range(4):
                imagedata = imagedata + block_64
            imagedata = imagedata + block_end
            size = len(imagedata)
...
if __name__ == '__main__':
    images=[]
    images.append((numpy.asarray(PIL.Image.open("D:\\OneDrive - connect.hku.hk\\25-Python Program\\21-Python Program（HKU LAB）\\Fringe_period_point0.bmp"))))
    ...
    dlp.defsequence(images,exposure,trigger_in,dark_time,trigger_out,3)
